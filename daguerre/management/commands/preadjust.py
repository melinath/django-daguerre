...
NO_ADJUSTMENTS = """No adjustments were defined. You'll need to add a DAGUERRE_PREADJUSTMENTS
...
class Command(NoArgsCommand):
	option_list = NoArgsCommand.option_list + (
		make_option(
			...
			dest='remove',
			default=False,
			help="Remove all adjustments that aren't listed in DAGUERRE_ADJUSTMENTS",
		),
	)
